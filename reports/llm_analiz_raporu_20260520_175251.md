...
- **Çözüm Komutu:** `sudo apt update && sudo apt upgrade -y && sudo apt install fail2ban`
...
- **Çözüm Komutu:** `sudo apt update && sudo apt upgrade -y && sudo apt install apparmor-sources && sudo systemctl restart apparmor`
