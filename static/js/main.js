        ...
        if (res.ok && res.report) {
          ...
          function formatMarkdownToHTML(text) {
            ...
            for (var i = 0; i < lines.length; i++) {
              ...
              } else if (l.toLowerCase().startsWith('- risk:') || l.toLowerCase().startsWith('- **risk:**') || l.toLowerCase().startsWith('risk:') || l.toLowerCase().startsWith('**risk:**')) {
              ...
              } else if (l.toLowerCase().startsWith('- müdahale önerisi:') || l.toLowerCase().startsWith('- **müdahale önerisi:**') || l.toLowerCase().startsWith('müdahale önerisi:') || l.toLowerCase().startsWith('**müdahale önerisi:**')) {
              ...
              } else if (l.toLowerCase().startsWith('- yapılacak:') || l.toLowerCase().startsWith('- **yapılacak:**') || l.toLowerCase().startsWith('- çözüm komutu:') || l.toLowerCase().startsWith('- **çözüm komutu:**') || l.toLowerCase().startsWith('çözüm komutu:') || l.toLowerCase().startsWith('**çözüm komutu:**')) {
              ...
              } else if (l.startsWith('CRITICAL') || l.startsWith('HIGH') || l.startsWith('MEDIUM') || l.startsWith('LOW')) {
                var color = '#fff';
                if (l.includes('CRITICAL')) color = 'var(--crit)';
                else if (l.includes('HIGH')) color = 'var(--warn)';
                else if (l.includes('MEDIUM')) color = 'var(--accent)';
                else if (l.includes('LOW')) color = 'var(--ok)';
                formatted += '<div style="color:' + color + ';font-weight:700;margin-top:16px;margin-bottom:2px;font-size:0.95rem;display:flex;align-items:center;gap:6px;">' + l + '</div>';
              } else if (l.startsWith('- ')) {
